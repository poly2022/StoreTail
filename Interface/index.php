...
<body>
  ...
  <main>
    <header class="position-relative">
      ...
      <div class="position-absolute bottom-0 start-0 w-100 bg-white">
        <div class="container">
          <ul class="nav nav-pills justify-content-center">
            <li class="nav-item">
              <a class="nav-link text-secondary me-3" href="#">New Books</a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-secondary me-3" href="#">Our Picks</a>
            </li>
            <li class="nav-item">
  ...
  <div class="container" style="max-height: 80vh; overflow-y: auto;">
    ...
    <div>
      <ul class="nav w-100 justify-content-center align-items-end mt-0 mb-0 p-0 m-0 custom-navbar">
        <li class="nav-item"><a href="#" class="nav-link fw-bold px-2 text-white">Books</a></li>
        <li class="nav-item"><a href="#" class="nav-link fw-bold px-2 text-white">Pricing</a></li>
        <li class="nav-item"><a href="#" class="nav-link fw-bold px-2 text-white">Support</a></li>
        <li class="nav-item"><a href="#" class="nav-link fw-bold px-2 text-white">Login</a></li>
        <li class="nav-item"><a href="#" class="nav-link fw-bold px-2 text-white">Terms</a></li>
        <li class="nav-item"><a href="#" class="nav-link fw-bold px-2 text-white">FAQs</a></li>
        <li class="nav-item"><a href="#" class="nav-link fw-bold px-2 text-white">About</a></li>
      </ul>

      <footer class="d-flex flex-wrap justify-content-center align-items-center py-1 my-0 border-top bg-dark border-dark">
        <div class="col-md-4 d-flex align-items-center">
          <span class="mb-2 mb-md-0 text-body-secondary" style="font-size: 14px">&copy; 2023 StoreTail, Inc</span>
        </div>

        <ul class="nav col-md-4 justify-content-end list-unstyled d-flex pe-0">
          <li class="ms-4"><a class="text-body-secondary" href="#"><svg class="bi" width="15" height="15">
