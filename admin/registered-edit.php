                                    ...
                                    foreach($query_run as $row)
                                    {
                                        ?>
                                            ...
                                            <div class="form--group">
                                                ...
                                                <input type="text" name="user_name"  value="<?php echo $row['user_name']; ?>" class="form-control" placeholder="User Name">
                                            </div>
                                            <div class="form--group">
                                            ...
                                            <div class="form--group">
                                                ...
                                                <input type="text" name="user_photo_url"  value="<?php echo $row['user_photo_url']; ?>" class="form-control" placeholder="user_photo_url">
                                            </div>          
                                        <?php
                                    }
                                }
